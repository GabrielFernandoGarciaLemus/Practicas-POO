...
public class BattleGame {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--------------------------------------");
        System.out.println("BIENVENIDO A  BATTLE GAME JOVEN LUCHADOR");
        System.out.println("---------------------------------------\n\n");

        System.out.println("Escoge sabiamente a tu luchador: ");
        ...
        while (pers.contains(opon)) {
            System.out.println("\nNo puedes escogerte como a ti mismo de oponente!!!!!");
            System.out.println("\nEscoge nuevamente a tu enemigo: ");
            System.out.println("\tA.Caballero");
            System.out.println("\tB.Guerrero");
            System.out.println("\tC.Mago");
            System.out.println("\tD.Computadora");
